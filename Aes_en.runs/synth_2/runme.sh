...
HD_PWD='F:/AZ_vivado/CA_project/Aes_en.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log SecureCache.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SecureCache.tcl
