...
HD_PWD='F:/AZ_vivado/CA_project/Aes_en.runs/impl_6'
cd "$HD_PWD"
...
EAStep vivado -log SecureCache.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SecureCache.tcl -notrace
